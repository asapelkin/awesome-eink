# Awesome E-ink [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)  
> A curated list of awesome E-ink links, projects and resources.
> Please if you have any suggestions, feel free to open an issue or pull request.
...
- [Tablets](#tablets)
- [Monitors](#monitors)
  - [Readers with built-in hdmi input](#readers-with-built-in-hdmi-input)
...
You can use e-ink almost everywhere, use cases are including but not limited to:
- [Readers](#readers)
- [Tablets](#tablets)
- [Monitors](#monitors)
- [Phones](#phones)
...
### Readers with built-in hdmi input
...
JetBrains IDE's:
- [Eink UI Theme](https://plugins.jetbrains.com/plugin/19687-eink-ui-theme)
- [Eink Color Scheme](https://plugins.jetbrains.com/plugin/17106-eink-color-scheme)
